# Collect temperature data from data.gov.sg using API. Load into local Postgres SQL database.
# Concepts practiced: Decorators, API, ETL, Functional Programming, Connecting and Interacting with local SQL Database
